    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_type', models.ForeignKey(to='grout.RecordType', on_delete=models.PROTECT)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='black_spot_set',
            field=models.ForeignKey(to='black_spots.BlackSpotSet', on_delete=models.PROTECT),
        ),
    ]
