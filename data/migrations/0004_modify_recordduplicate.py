...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='duplicate_record', to='grout.Record', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='recordduplicate',
            name='modified',
        ...
        migrations.AddField(
            model_name='recordduplicate',
            name='record',
            field=models.ForeignKey(related_name='record', to='grout.Record', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='recordduplicate',
            name='score',
