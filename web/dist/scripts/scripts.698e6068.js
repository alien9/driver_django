!function() {
    ...
    var a = {
        ...
        recordType: {
            ...
            secondaryLabel: "Intervencion"
        },
        localization: {
            timeZone: "America/La_Paz",
            countryCode: "bo",
            centerLatLon: [-16.5, -68.15],
            zoom: 12,
            languages: [{
                id: "es",
                label: "Español",
...
function() {
    ...
    function b(a) {
        function b(b, c, d, e) {
            var f = a.get()
              , g = new L.map(c[0],f);
            L.Icon.Default.imagePath || (L.Icon.Default.imagePath = "styles/images"),
            e.setMap(g)
        }
        var c = {
            restrict: "A",
